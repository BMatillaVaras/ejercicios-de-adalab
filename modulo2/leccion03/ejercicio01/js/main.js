...
//userImg.setAttribute("src", userAvatar); // con setAttribute añadimos atributos a la const que hemos declarado antes, en este caso src y le decimos que sea la variable del enunciado.
